...
<!-- Add this CSS inside your stylesheet or a <style> tag -->
<style>
...
<!-- Include AOS JS before </body> if not already included -->
...
#projects {
  background-color: #ffffff !important; /* force solid black */
  color: #000000;
  padding: 60px 0;
}
...
#contact {
  background-color: #EDE8D0 !important; /* force solid black */
  color: #000000;
  padding: 60px 0;
}

.profile-img {
      width: 180px;     /* adjust between 150–200px as you prefer */
      height: 180px;
      object-fit: cover;
}
.card,.project-card {
  flex: 1 1 20%; /* each takes up roughly 1/4 of the row */
  max-width: 300px;
  min-width: 250px;
  display: flex;
...
<!-- Include AOS CSS in <head> if not already included -->
<link href="https://unpkg.com/aos@2.3.4/dist/aos.css" rel="stylesheet" />
